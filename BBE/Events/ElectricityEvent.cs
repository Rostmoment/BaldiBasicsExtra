...
namespace BBE.Events
{
    public class ElectricityEvent : ModifiedEvent
    {
        ...
        private SoundObject StartSound = AssetsHelper.CreateSoundObject("Audio/Events/BurstPowerDown.mp3", SoundType.Effect, Subtitle: false);
