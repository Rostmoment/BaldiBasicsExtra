...
namespace BBE.Events.HookChaos
{
    public class NPCHook : MonoBehaviour
    {
        ...
        private void preInitialize() //initialize all components
        {
            ...
            lineRenderer.material = CachedAssets.lineMaterial;
            ...
            spriteRenderer.sprite = CachedAssets.hookSprite;
            ...
            cracksRenderer.sprite = CachedAssets.cracksSprite;
            ...
            motorAudio.clip = CachedAssets.grappleLoopSound;
        ...
        public void initialize(NPC character, EnvironmentController ec)
        {
            ...
            audMan.PlaySingle(CachedAssets.grappleLaunchSound);
        }
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if (layerMask.Contains(collision.gameObject.layer) && !locked && collision.gameObject.tag != "Player" && collision.gameObject.tag != "NPC")
            {
                ...
                audMan.PlaySingle(CachedAssets.grappleClangSound);
                motorAudio.Play();
        ...
        public void Break()
        {
            ...
            audMan.QueueAudio(CachedAssets.baldiBreak);
            motorAudio.Stop();
