...
namespace BBE.Extensions
{
    public static class EnumExtensions
    {
        ...
        public static LayerMask ToLayer(this Layer layer)
        {
            ...
            {
                case Layer.Window:
                    return LayerMask.NameToLayer("Window");
                case Layer.Billboard:
                    return LayerMask.NameToLayer("Billboard");
                case Layer.IClickable:
                    return LayerMask.NameToLayer("ClickableCollidableEntities");
                case Layer.IgnoreRaycast:
                    return LayerMask.NameToLayer("Ignore Raycast");
                case Layer.BlockRaycast:
                    return LayerMask.NameToLayer("Block Raycast");
                case Layer.StandardEntities:
                    return LayerMask.NameToLayer("StandardEntities");
                case Layer.Map:
                    return LayerMask.NameToLayer("Map");
                case Layer.UI:
                    return LayerMask.NameToLayer("UI");
                case Layer.GumCollision:
                    return 2113537;
                case Layer.EntityCollision:
                    return 2113541;
                case Layer.PrincipalLooker:
                    return 2326529;
                case Layer.ClickableEntities:
                    return LayerMask.NameToLayer("ClickableEntities");
                default:
                    return Layer.Window.ToLayer();
            }
