...
namespace BBE.Extensions
{
    public static class ExtensionsAPI
    {
        ...
        public static ItemObject BuildAndSetup(this ItemBuilder itm)
        {
            ...
            PlusLevelLoaderPlugin.Instance.itemObjects.Add(MTM101BaldAPI.EnumExtensions.ToStringExtended(item.itemType), item);
            return item;
        }
        ...
        public static N BuildAndSetup<N>(this NPCBuilder<N> npc) where N : NPC
        {
            ...
            if (res.gameObject.TryGetComponent<INPCPrefab>(out INPCPrefab prefab))
                prefab.SetupAssets();
            PlusLevelLoaderPlugin.Instance.npcAliases.Add(MTM101BaldAPI.EnumExtensions.ToStringExtended(npc.characterEnum), res);
            return res;
        }
