    ...
    public class GlueResidue : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (other.CompareTag("NPC"))
            {
                ...
                npcs.Add(npc);
                if (npc.TryGetComponent<ActivityModifier>(out ActivityModifier activityModifier))
                {
                    audMan.PlaySingle("Ben_Splat", false);
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            if (other.CompareTag("NPC"))
            {
                ...
                if (npc.TryGetComponent<ActivityModifier>(out ActivityModifier activityModifier) && activityModifier.moveMods.Contains(moveMod))
                {
