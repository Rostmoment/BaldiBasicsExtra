...
namespace BBE.Helpers
{
    ...
    class Creator
    {
        public static void CreateTextures()
        {
            ...
            for (int i = 1; i<21; i++)
            {
                BasePlugin.Instance.asset.Add<Sprite>("Exit" + i, AssetsHelper.TextureFromFile("Textures", "Other", "Exit", i + ".png").ToSprite());
            }
            BasePlugin.Instance.asset.Add<Sprite>("FolderIcon", AssetsHelper.TextureFromFile("Textures", "Other", "Folder.png").ToSprite());
            BasePlugin.Instance.asset.Add<Sprite>("GamebananaIcon", AssetsHelper.TextureFromFile("Textures", "Other", "Gamebanana.png").ToSprite());
            BasePlugin.Instance.asset.Add<Sprite>("GithubIcon", AssetsHelper.TextureFromFile("Textures", "Other", "Github.png").ToSprite());
            BasePlugin.Instance.asset.Add<Texture2D>("FunSettingsIcon", AssetsHelper.TextureFromFile("Textures", "Other", "FunSettingBG.png"));
    ...
    class CreateObjects
    {
        ...
        public static void CreateEvent<T>(string name, string desk, int weight, float minEventTime, float maxEventTime, params Floor[] floors) where T : RandomEvent
        {
            ...
            CustomEventData data = new CustomEventData { Name = name, Weight = weight };
            foreach (Floor floor in floors)
            {
                FloorData.AddEvent(data, floor);
            }
