...
namespace BBE.Helpers
{
    ...
    class Creator
    {
        ...
        {   
            ...
            CreateObjects.CreateItem<ITM_SpeedPotion>("Item_Potion_Desk", "Item_Potion", "SpeedPotion", 60, "Potion.png", 100, 600, pixelsPerUnitLargeTexture: 480f, flags: ItemFlags.Persists);
    ...
    class CreateObjects
    {
        ...
        {
            TMP_Text res = UnityEngine.Object.Instantiate(PrivateDataHelper.GetVariable<TMP_Text[]>(Singleton<CoreGameManager>.Instance.GetHud(0), "textBox")[0]);
