...
namespace BBE.Helpers
{
    ...
    class Creator
    {
        ...
        public static void CreateSounds()
        {
            ...
            BasePlugin.Instance.asset.Add<AudioClip>("DeafSound", AssetsHelper.AudioFromFile("Audio", "Events", "Starts", "SoundEvent.mp3"));
            ...
            BasePlugin.Instance.asset.Add<SoundObject>("ElectricityEventStart", AssetsHelper.CreateSoundObject("Audio/Events/BurstPowerDown.mp3", SoundType.Effect, sublength: 0));
            BasePlugin.Instance.asset.Add<SoundObject>("FireEventStart", AssetsHelper.CreateSoundObject("Audio/Events/LightFire.mp3", SoundType.Effect, sublength: 0));
            BasePlugin.Instance.asset.Add<SoundObject>("TeleportationEventStart", AssetsHelper.CreateSoundObject("Audio/Events/EventTCStarted.ogg", SoundType.Effect, sublength: 0));
        ...
        {
            SoundObject sound = AssetsHelper.CreateSoundObject("Audio/Events/Starts/TeleportationChaos.wav", SoundType.Voice, Color.green, 11.3f, "Event_TeleportationChaos1");
            sound = sound.AddAdditionalKey("Event_TeleportationChaos2", 5.2f);
            CreateObjects.CreateEvent<TeleportationChaosEvent>("TeleportationChaos", "Event_TeleportationChaos", 60, sound, Floor.Floor2, Floor.Floor3);
            CreateObjects.CreateEvent<SoundEvent>("SoundEvent", "Event_Sound", 45, 50, 60, sound, Floor.Floor1);
            sound = AssetsHelper.CreateSoundObject("Audio/Events/Starts/HookChaos.wav", SoundType.Voice, Color.green, 11.3f, "Event_HookChaos1");
            sound = sound.AddAdditionalKey("Event_HookChaos2", 5.03f).AddAdditionalKey("Event_HookChaos3", 8.23f);
            CreateObjects.CreateEvent<HookChaosEvent>("HookChaos", "Event_HookChaos", 60, 90, 120, sound, Floor.Floor2, Floor.Floor3, Floor.Endless);
            sound = AssetsHelper.CreateSoundObject("Audio/Events/Starts/ElectricityEvent.wav", SoundType.Voice, Color.green, 9.2f, "Event_Electricity1");
            sound = sound.AddAdditionalKey("Event_Electricity2", 5f);
            CreateObjects.CreateEvent<ElectricityEvent>("ElectricityEvent", "Event_Electricity", 30, 60, 90, sound, Floor.Floor2, Floor.Floor3, Floor.Endless);
            sound = AssetsHelper.CreateSoundObject("Audio/Events/Starts/FireEvent.wav", SoundType.Voice, Color.green, 11.3f, "Event_Fire1");
            sound = sound.AddAdditionalKey("Event_Fire2", 1.9f).AddAdditionalKey("Event_Fire3", 5.4f).AddAdditionalKey("Event_Fire4", 8.3f);
            CreateObjects.CreateEvent<FireEvent>("FireEvent", "Event_Fire", 60, 60, 90, sound, Floor.Floor2, Floor.Endless);
    ...
    class CreateObjects
    {
        ...
        public static void CreateEvent<T>(string name, string desk, int weight, SoundObject startSound, params Floor[] floors) where T : RandomEvent
        {
            CreateEvent<T>(name, desk, weight, 30, 60, startSound, floors);
        }
        public static void CreateEvent<T>(string name, string desk, int weight, float minEventTime, float maxEventTime, SoundObject startSound, params Floor[] floors) where T : RandomEvent
        {
