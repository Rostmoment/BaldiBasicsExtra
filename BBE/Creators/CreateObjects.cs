...
namespace BBE.Creators
{
    class Creator
    {
        public static void CreateTextures()
        {
            ...
            BasePlugin.Asset.Add<Texture2D>("UselessFactPoster", AssetsHelper.CreateTexture("Textures", "Posters", "BBE_UselessFact.png"));
            ...
            BasePlugin.Asset.Add<Texture2D>("LevelUp", AssetsHelper.CreateTexture("Textures", "Objects", "BBE_LevelUp.png"));
            BasePlugin.Asset.Add<Texture2D>("LevelDown", AssetsHelper.CreateTexture("Textures", "Objects", "BBE_LevelDown.png"));
            BasePlugin.Asset.Add<Texture2D>("LevelUpGuide", AssetsHelper.CreateTexture("Textures", "Objects", "BBE_LeverUpGuide.png"));
            BasePlugin.Asset.Add<Texture2D>("LevelDownGuide", AssetsHelper.CreateTexture("Textures", "Objects", "BBE_LeverDownGuide.png"));
        ...
        public static void CreateFunSettings()
        {
            ...
            /*
            new FunSettingBuilder(BasePlugin.Instance.Info, "BBE_BadMapFunSetting")
                .SetName("BBE_BadMapFunSetting")
                .SetEnum(FunSettingsType.BadMap)
                .SetLockedDescription("BBE_BadMapFunSettingLockedDesc")
                .Hide()
                .SetDescription("BBE_BadMapFunSettingDesc")
                .Build();*/
        }
    }
    class CreateObjects
