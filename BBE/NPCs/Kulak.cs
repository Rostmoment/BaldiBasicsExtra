...
namespace BBE.NPCs
{
    public class Kulak : NPC, INPCPrefab
    {
        public void SetupAssets()
        {
            ...
            if (getOut == null)
                AssetsHelper.CreateSoundObject(AssetsHelper.AudioFromFile("Audio", "NPCs", "Kulak", "BBE_Kulak_GetOut.wav"), SoundType.Voice, "f5de5b", subtitleKey: "BBE_Kulak_GetOut");
            if (smash == null)
                AssetsHelper.CreateSoundObject(AssetsHelper.AudioFromFile("Audio", "NPCs", "Kulak", "BBE_Kulak_Smash.wav"), SoundType.Voice, "f5de5b", subtitleKey: "BBE_Kulak_Smash");
            if (hiya == null)
