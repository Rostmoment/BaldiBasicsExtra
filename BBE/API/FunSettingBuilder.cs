...
namespace BBE.API
{
    ...
    public class FunSettingBuilder
    {
        ...
        public FunSetting Build()
        {
            ...
            return FunSetting.CreateFunSetting(pluginInfo, funSettingName, Enum, description, dependies, notAllowed, OnEnabling, OnDisabling, OnHighlight);
        }
        ...
        /// <summary>
        /// Sets the action to be executed when the fun setting is enabled through PineDebug
        /// </summary>
        ...
        /// <summary>
        /// Sets the action to be executed when the fun setting is disabled through PineDebug
        /// </summary>
        ...
        /// <summary>
        /// Sets the action to be executed when the player hovers the mouse cursor over the fun setting button
        /// </summary>
